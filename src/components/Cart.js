   ...
   const onClearCart =()=>{
    ...
    return <div className="text-center m-4 p-4">
      ...
      {cartItems.length != 0 &&   <button className="p-2 ml-10 bg-orange-500 font-semibold text-white  rounded-lg" onClick={onClearCart}>Clear Cart</button>}
        ...
        <div >
        {cartItems.length === 0 && <div className="w-4/12 mx-auto my-4 bg-gray-50 p-4 shadow-lg">
       ...
       {cartItems.length > 0 && <div className="w-4/12 mx-auto my-4 bg-gray-50 p-4 rounded-lg border-2 shadow-lg">
